    ...
    <>
      <section className="contenedorPrincipal">
        ...
        <div className="contenedorEquipo">
          <Image
            src="/images/imageEstadistica/nacional.png"
            width={300}
            height={300}
            className="imageEquipo"
          />
          ...
          <div className="contenedorFaltas">
            <table>
              <tr className="columnas">
                <th>
                  <div className="falta amarilla"> </div>
                </th>
                <th>
                  <div className="falta roja"> </div>
                </th>
                <th>
                  <Image
                    src="/images/imageEstadistica/balon.png"
                    width={30}
                    height={30}
                  />
                </th>
        ...
        <div className="contenedorEquipo">
          <Image
            src="/images/imageEstadistica/MILONARIOS.png"
            width={300}
            height={300}
            className="imageEquipo"
          />
